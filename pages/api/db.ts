// Importamos as constantes do arquivo encontrado
// na pasta "locale".
import { locales } from "../../locale/constants";
const { EN_US, ES_ES, PT_BR } = locales;

// Aqui encontramos as informações que devemos retornar
// em cada uma de nossas rotas de API com base no
// idioma selecionado

// Para a rota de produtos em destaque
    ...
    tycs: [
      {
        id: 1,
        title: "Geral",
        description: `A Loja Gratuita é uma empresa que oferece serviços ligados principalmente ao comércio electrónico.
